...
export default function CadastroScreen({ navigation }: { navigation: any }) {
  ...
  // Força senha
  const [forca, setForca] = useState(0); // 0–4
  ...
  const handleCadastro = async () => {
    ...
    //  Aqui você salvaria no banco real (caso eu saia na quarta pro medico)
    const novoUsuario = {
      id: gerarId(),
      nome: nome.trim(),
  ...
  //  Dimensões responsivas (mesma lógica do Login hehehe copiei) 
